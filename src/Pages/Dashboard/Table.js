  ...
  return (
    <>
      <tr>
        ...
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
          <p className="text-accent-900 whitespace-no-wrap">{patientName}</p>
        </td>

        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
          <p className="text-accent-900 whitespace-no-wrap">{treatment}</p>
        </td>
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
          <p className="text-accent-900 whitespace-no-wrap">{slot}</p>
        </td>
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
          {price && !paid && (
