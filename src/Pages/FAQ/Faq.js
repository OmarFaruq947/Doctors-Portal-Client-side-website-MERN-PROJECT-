  ...
  return (
    <>
      <div className="p-8 my-28">
        <h4 className="text-4xl font-bold text-accent-800 tracking-widest uppercase text-center">
          FAQ
        </h4>
        <p className="text-center text-accent-600 text-sm mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-12 px-2 xl:px-12 mt-4">
          <div className="flex space-x-8 mt-8">
            ...
            <div>
              ...
              <p className="text-accent-600 my-2">
