  ...
  return (
    <>
      <div className="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 px-4 py-9">
        <h1 className="text-center lg:mb-20 mb-10  text-accent-800 font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 w-9/12 md:w-full mx-auto">
          Review our institute
        </h1>
        <div className="relative md:flex justify-center items-center">
          <div className="md:w-4/12 w-full">
            <div className="flex space-x-2 md:mt-0 mt-10">
              <svg
                className="cursor-pointer text-accent-800"
                width={20}
                height={19}
                viewBox="0 0 20 19"
                fill="none"
              ...
              <p className="text-accent-600 text-base dark:text-accent-400 leading-4 font-normal">
                5/5
              </p>
            </div>
            <h3 className="text-accent-800 my-4  font-semibold lg:text-2xl text-xl lg:leading-6 leading-5">
              Based On 170 reviews
            </h3>
            <a
              href="javascript:void(0)"
              className="hover:text-accent-800 dark:text-accent-400 focus:outline-none focus:text-black hover:underline text-sm leading-3 text-accent-600 cursor-pointer"
            >
              See all reviews
            </a>
          </div>
          ...
          <div className="hidden md:block relative md:w-8/12 w-full overflow-x-hidden md:mt-0 mt-10">
            ...
            >
                ...
                <div className="w-full">
                  <div className="mb-6">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M78.6941 4.70213V7.85222C78.6941 7.85222 75.6022 5.96217 72.184 5.92391C72.184 5.92391 65.8085 5.80019 65.5204 12C65.5204 12 65.29 17.7034 72.1073 18.028C72.1073 18.028 74.9687 18.3717 78.8478 15.9089V19.1735C78.8478 19.1735 73.6437 22.2471 67.6136 19.8798C67.6136 19.8798 62.5438 18.0379 62.3516 12C62.3516 12 62.1402 5.79034 68.9002 3.72847C68.9002 3.72847 70.7055 3.04118 73.9508 3.34656C73.9508 3.34656 75.8903 3.53763 78.6941 4.70213ZM58.5391 23.8608H83.86V0.139202H58.5391V23.8608Z"
                        fill="currentColor"
                      />
                    </svg>
                  </div>
                  <div className="md:w-full h-full relative">
                    <p className="text-accent-600 dark:text-accent-400 font-normal text-base leading-7">
                      “ I love this. Thanks. The seeker has solitude, but not
                      everyone disturbs it The body of suffering is full of
                      fear. I am fully satisfied and would recommend buying from
              ...
              <div className="w-72 flex-none">
                <div className="w-full">
                  <div className="mb-6 text-accent-800 ">
                    <svg
                      width={115}
                      height={24}
                      viewBox="0 0 115 24"
                    ...
                    >
                      ...
                      />
                      <path
                        className="text-white dark:text-accent-900"
                        fillRule="evenodd"
                        clipRule="evenodd"
                  ...
                  <p className="text-accent-600 dark:text-accent-400 font-normal text-base leading-7">
                    “ It was an absolute pleasure working with them. They are
                ...
                <div className="w-full">
                  <div className="mb-6">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M60.6706 19.0529L55.5537 5.76172H59.014L62.3272 14.9494L65.5908 5.76617H69.0512L61.9061 24.4137H58.4458L60.6706 19.0529ZM71.0006 17.2095C71.0006 18.5892 70.0681 19.509 68.7299 19.509C67.4186 19.509 66.484 18.5351 66.484 17.2095C66.484 15.884 67.4179 14.91 68.7299 14.91C70.0674 14.91 71.0006 15.884 71.0006 17.2095Z"
                        fill="currentColor"
                      />
                    </svg>
                  </div>
                  <p className="text-accent-600 dark:text-accent-400 font-normal text-base leading-7">
                    “ I love this. Thanks. The seeker has solitude. I am fully
                    satisfied and would recommend buying from them as they have
            ...
            <div className="flex justify-end items-end mt-10 pr-2 pb-1">
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className="text-accent-600 dark:text-accent-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer"
                >
                  <svg
                    width={40}
                    height={40}
      ...
      <section className="text-accent-400  body-font">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div className="h-full text-center">
                ...
                <p className="text-accent-500">Senior Product Designer</p>
              </div>
            </div>
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div className="h-full text-center">
                ...
                <p className="text-accent-500">UI Develeoper</p>
              </div>
            </div>
            <div className="lg:w-1/3 lg:mb-0 p-4">
              <div className="h-full text-center">
                ...
                <p className="text-accent-500">CTO</p>
              </div>
            </div>
          </div>
        </div>
